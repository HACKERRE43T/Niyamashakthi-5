...
// Function to get a response from the Hugging Face API using Mistral-7B-Instruct-v0.3
async function getResponseFromAPI(input) {
    ...
    const url = "https://api-inference.huggingface.co/models/mistralai/Mistral-7B-Instruct-v0.3";  // Updated model URL
